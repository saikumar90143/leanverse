...
{/* Step 1: Biometrics */}
 ...
 <div className="flex justify-between items-center">
 <span className="text-[10px] text-muted font-extrabold uppercase tracking-widest block">Calories</span>
 <span className="text-[10px] text-muted font-bold block">Target: {calsTarget}</span>
 </div>
 <span className={`text-2xl sm:text-3xl font-black mt-1 block ${isOver(actualCals, calsTarget) ? 'text-red-500' : 'text-foreground'}`}>
 {actualCals} <span className="text-xs text-muted font-bold">kcal</span>
 </span>
 </div>
 ...
 <span className="text-[10px] text-muted font-bold block">Target: {proteinTarget}g</span>
 </div>
 ...
 <span className="text-[10px] text-muted font-bold block">Target: {carbsTarget}g</span>
 </div>
 ...
 <span className="text-[10px] text-muted font-bold block">Target: {fatsTarget}g</span>
 </div>
 ...
 <button type="button" onClick={() => setShowCustomForm(null)} className="text-muted hover:text-muted text-xs font-bold cursor-pointer">Cancel</button>
 </div>
 ...
 <div className="glass p-6 rounded-3xl border border-border/10 flex flex-col items-center space-y-3">
 <span className="text-xs font-black text-muted uppercase tracking-widest block self-start">Today's Eaten Progress</span>
 <MacroRings
 protein={eatenProtein}
 carbs={eatenCarbs}
 fats={eatenFats}
 ...
 {/* Grocery list */}
 <div className="glass p-6 rounded-3xl border border-border/10 space-y-4 relative">
 <div className="flex items-center justify-between">
 <span className="text-xs font-black text-muted uppercase tracking-widest block">Weekly Grocery List</span>
 <button
 onClick={handleCopyGrocery}
 ...
 <ul className="space-y-2 text-xs font-semibold text-muted dark:text-slate-350">
