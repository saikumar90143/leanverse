...
export default function MealRecipesPage() {
 ...
 <p className="text-xs text-muted">Search healthy diet plates or input raw ingredients in our AI Generator to get a complete macro recipe card instantly!</p>
 </div>
 ...
 <div className="flex items-center space-x-2 border-b border-border/10 pb-4 mb-6">
 <Sparkles className="w-5 h-5 text-amber-500 fill-current" />
 <h2 className="font-extrabold text-foreground text-base">Instant AI Recipe Generator</h2>
 </div>

 <form onSubmit={handleGenerateRecipe} className="space-y-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-muted block ml-1">What ingredients are in your kitchen? (Comma-separated)</label>
 ...
 required
 className="flex-1 bg-secondary/50 dark:bg-card/5 border border-slate-350/20 dark:border-border rounded-2xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-500 font-medium text-foreground"
 />
 <button
 type="submit"
 disabled={generating}
 ...
 <h3 className="font-extrabold text-foreground text-base mt-1">{generatedRecipe.name}</h3>
 </div>
 <div className="flex items-center space-x-1 text-muted font-bold text-xs">
 ...
 {/* Macros */}
 <div className="grid grid-cols-4 gap-2 text-center py-2 bg-secondary/20 dark:bg-card/5 rounded-xl border border-border/5">
 <div>
 <span className="text-[9px] text-muted font-bold block uppercase">Calories</span>
 <span className="text-sm font-black text-foreground mt-0.5 block">{generatedRecipe.cals}</span>
 </div>
 <div>
 ...
 <span className="text-[10px] text-muted font-extrabold uppercase tracking-wider block">Ingredients Used</span>
 <ul className="space-y-1 text-muted dark:text-slate-350">
 ...
 <div className="space-y-2">
 <span className="text-[10px] text-muted font-extrabold uppercase tracking-wider block">Preparation steps</span>
 <ol className="space-y-1.5 text-muted dark:text-slate-350 list-decimal pl-4">
 ...
 <span className="text-xs font-black text-muted uppercase tracking-widest block">Diet Plates Directory</span>
 ...
 className="bg-secondary/50 dark:bg-card/5 border border-slate-350/15 dark:border-border rounded-xl pl-9 pr-4 py-2 text-xs focus:outline-none focus:border-emerald-500 text-foreground font-medium"
 />
 </div>
 ...
 className="bg-secondary/50 border border-slate-350/15 dark:border-border rounded-xl px-3.5 py-2.5 text-xs focus:outline-none focus:border-emerald-500 font-bold"
 >
 ...
 <div key={idx} className="glass rounded-3xl p-6 border border-border/10 flex flex-col justify-between space-y-4 glow-card">
 <div className="space-y-2">
 ...
 <span className="text-[10px] text-muted font-bold flex items-center">
 <Clock className="w-3.5 h-3.5 mr-0.5" />
 {r.time}
 </span>
 </div>
 <h3 className="font-extrabold text-foreground text-sm leading-snug">{r.name}</h3>
 </div>

 {/* Macro info */}
 <div className="grid grid-cols-4 gap-1 p-2 bg-secondary/20 dark:bg-card/5 rounded-xl border border-border/5 text-center text-[10px] font-black">
 <div>
 <span className="text-muted block font-bold text-[8px] uppercase">Cal</span>
 <span className="text-foreground dark:text-slate-350">{r.cals}</span>
 </div>
 <div>
 ...
 <span className="font-bold text-muted">Key Ingredients:</span>
 ...
 className="w-full py-2 bg-secondary/50 dark:bg-card/5 hover:bg-emerald-500/10 text-muted hover:text-emerald-500 rounded-xl font-bold transition-all text-xs flex items-center justify-center cursor-pointer"
 >
 ...
 <div className="col-span-3 text-center py-10 text-xs text-muted font-bold">
