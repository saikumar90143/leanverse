...
export default function BMICalculator() {
 ...
 <div className="lg:col-span-7 glass rounded-3xl p-6 sm:p-8 shadow-2xl border border-border/20 dark:border-border relative">
 ...
 <span className="text-sm font-bold text-muted">Height</span>
 ...
 <span className="text-xs font-bold text-muted block ml-1">Visual BMI Metric</span>
 ...
 >
 <span className={`text-xs font-black px-2 py-0.5 rounded-md bg-foreground text-white dark:bg-card dark:text-slate-950 shadow-md mb-1`}>
 {bmi}
 </span>
 <div className="w-2 h-2 rotate-45 bg-foreground dark:bg-card" />
 </div>

 {/* Bar segments */}
 <div className="w-full h-3 rounded-full overflow-hidden flex bg-secondary dark:bg-card/5 border border-border/10">
 ...
 {/* Scale Labels */}
 <div className="flex justify-between text-[10px] text-muted font-extrabold mt-2 px-1">
 <span>15.0</span>
 <span>18.5</span>
 <span>25.0</span>
 <span>30.0</span>
 ...
 <div className="glass rounded-3xl p-6 sm:p-8 shadow-2xl border border-border/20 dark:border-border relative overflow-hidden">
 <div className="absolute top-0 right-0 w-24 h-24 bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full blur-2xl -z-10" />
 
 <span className="text-xs font-black text-muted uppercase tracking-widest block mb-1">Your Calculation</span>
 <div className="flex items-baseline space-x-2">
 <span className="text-5xl font-black tracking-tight text-foreground">{bmi}</span>
 <span className={`text-lg font-bold uppercase ${getCategoryColor()}`}>{category}</span>
 </div>

 <div className="border-t border-border/15 dark:border-border my-6 pt-6 space-y-4">
 <div className="flex items-start space-x-2.5">
 <Heart className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
 <div>
 <span className="text-xs font-extrabold text-muted uppercase tracking-wider block">Health Suggestion</span>
 ...
 <div>
 <span className="text-xs font-extrabold text-muted uppercase tracking-wider block">Next Level Tip</span>
 <p className="text-sm text-muted leading-relaxed mt-1">
 ...
 <div className="glass rounded-2xl p-5 border border-border/10 space-y-3">
 <span className="text-xs font-black text-muted uppercase tracking-widest block">More Calculators</span>
 <div className="grid grid-cols-2 gap-2 text-xs">
 <Link href="/calculators/maintenance" className="p-3 bg-secondary/50 dark:bg-card/5 hover:bg-emerald-500/10 rounded-xl font-bold transition-all border border-border/10 block text-center">TDEE Calories</Link>
 <Link href="/calculators/macro" className="p-3 bg-secondary/50 dark:bg-card/5 hover:bg-emerald-500/10 rounded-xl font-bold transition-all border border-border/10 block text-center">Macro Splits</Link>
 <Link href="/calculators/body-fat" className="p-3 bg-secondary/50 dark:bg-card/5 hover:bg-emerald-500/10 rounded-xl font-bold transition-all border border-border/10 block text-center">Body Fat %</Link>
 <Link href="/calculators/water" className="p-3 bg-secondary/50 dark:bg-card/5 hover:bg-emerald-500/10 rounded-xl font-bold transition-all border border-border/10 block text-center">Water Dial</Link>
 </div>
 </div>
 </div>
 </div>
