  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {metrics.map((m) => (
          <div key={m.label} className="glass rounded-2xl p-5 border border-slate-200/10 dark:border-white/5">
            ...
            <p className="text-2xl font-black text-slate-800 dark:text-white mt-0.5">{m.value}</p>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          return (
            <div key={label} className="glass rounded-2xl p-5 border border-slate-200/10 dark:border-white/5">
              <h3 className="text-xs font-black text-slate-500 dark:text-zinc-400 uppercase tracking-widest mb-4">{label}</h3>
      ...
      <div className="glass rounded-2xl p-5 border border-slate-200/10 dark:border-white/5">
        <h3 className="text-xs font-black text-slate-500 dark:text-zinc-400 uppercase tracking-widest mb-4">Retention by Day (Cohort Week 1)</h3>
      ...
      {/* AI Growth Insights */}
      <div className="glass rounded-2xl p-5 border border-slate-200/10 dark:border-white/5 space-y-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-violet-500/10 text-violet-500">
            <Lightbulb className="w-4 h-4" />
          </div>
          <div>
            <h3 className="font-black text-slate-800 dark:text-white text-sm">AI Growth Insights</h3>
            <p className="text-[10px] text-slate-400">AI-powered recommendations to grow your platform</p>
          </div>
        </div>
