    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="glass rounded-3xl p-8 sm:p-12 shadow-2xl border border-slate-200/20 dark:border-white/10">
        <div className="flex items-center space-x-4 mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-slate-800 dark:text-white tracking-tight">Medical Disclaimer</h1>
        </div>
        ...
        <div className="prose dark:prose-invert prose-emerald max-w-none space-y-6 text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-white mt-8 mb-4">Not a Substitute for Professional Advice</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-white mt-8 mb-4">Assumption of Risk</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-white mt-8 mb-4">Accuracy of Information</h2>
          <p>
