  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted">Last updated: May 28, 2026. Review our structural user protection guidelines.</p>
      </div>

      {/* Content blocks */}
      <div className="glass rounded-3xl p-6 sm:p-8 border border-border/10 shadow-xl space-y-8 text-sm leading-relaxed text-muted dark:text-slate-350">
        
        {/* Section 1 */}
        <section className="space-y-3">
          <div className="flex items-center space-x-2 border-b border-border/10 pb-2">
            <Lock className="w-4 h-4 text-emerald-500" />
            <h2 className="text-base font-black text-foreground">1. Data Storage & Privacy</h2>
          </div>
        ...
        <section className="space-y-3" id="terms">
          <div className="flex items-center space-x-2 border-b border-border/10 pb-2">
            ...
            <h2 className="text-base font-black text-foreground">2. Terms of Service & Disclaimer</h2>
          </div>
          <p className="font-semibold text-xs text-muted">
        ...
        <section className="space-y-3">
          <div className="flex items-center space-x-2 border-b border-border/10 pb-2">
            ...
            <h2 className="text-base font-black text-foreground">3. Cookies & Monetization</h2>
          </div>
          <p className="font-semibold text-xs text-muted">
