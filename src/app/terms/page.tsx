    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="glass rounded-3xl p-8 sm:p-12 shadow-2xl border border-border/20 dark:border-border">
        ...
        <div className="prose dark:prose-invert prose-emerald max-w-none space-y-6 text-muted">
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">2. Provision of Service</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">3. User Accounts & Data</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">5. Disclaimer of Warranties</h2>
          <p>
